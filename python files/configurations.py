...
#initializing app
bucket_url = 'gs://archives-database-e5267.appspot.com'
service_acct_key = 'sdk/service_key_archives_database_adminsdk.json'
...
def convert_to_blob(image_file):
    blob = bucket.blob('images/my-image.jpg')
